...
#define MTBBUS_SPEEDS 5
const uint32_t _speed_to_br[MTBBUS_SPEEDS] = {38400, 38400, 57600, 115200, 230400};
const size_t _speed_to_inq_period[MTBBUS_SPEEDS] = {30, 30, 20, 10, 7}; // in 100us
